...
// Initialises a new instance of the Stripe SDK with the provided API key
...
export const postStripeSession = async ({ priceId }: NewSessionProps) => {
  // Defines the URL to which the user will be redirected after completing or cancelling the payment.
  const returnUrl =
